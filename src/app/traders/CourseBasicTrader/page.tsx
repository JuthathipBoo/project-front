...
const CourseBasicTrader = () => {
  ...
  return (
    <div className="CourseBasicTrader-warrapper">
      <NavbarTrader />
      <div className="CourseBasicTrader-container">
        <div className="CourseBasicTrader-container-search-input">
          <i className="bi bi-search"></i>
          <input type="text" placeholder="ค้นหารหัสผู้ค้าตราสารหนี้" />
        </div>

        <div className="CourseBasicTrader-container-link">
          <Link
            href="/traders/trainingsCourse"
            className="CourseBasicTrader-nav-item"
          >
            หลักสูตรทั้งหมด
          </Link>
          <Link
      ...
      <div className="CourseBasicTrader-container-card">
        {trainings.length > 0 ? (
...
export default CourseBasicTrader;
