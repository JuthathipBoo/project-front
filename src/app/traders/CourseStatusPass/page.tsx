...
const CourseStatusPass = () => {
        ...
        try {
          ...
          if (Array.isArray(data)) {
            ...
            const approvedStatus = data.filter(
              (course: Training) => course.statusCourse === "ยืนยันการผ่านอบรม"
            );
  ...
  return (
    <div className="CourseStatusPass-warrapper">
      <NavbarTrader />
      <div className="CourseStatusPass-container">
        <div className="CourseStatusPass-container-search-input">
          <i className="bi bi-search"></i>
          <input type="text" placeholder="ค้นหาหลักสูตรอบรม" />
        </div>
        <div className="CourseStatusPass-container-link">
          <Link
            href="/traders/TrainingHistory"
            className="CourseStatusPass-nav-item"
          >
            หลักสูตรทั้งหมด
          </Link>
          <Link
      ...
      <div className="CourseStatusPass-container-card">
      {isLoading ? (
          <p>กำลังโหลด...</p>
...
export default CourseStatusPass;
