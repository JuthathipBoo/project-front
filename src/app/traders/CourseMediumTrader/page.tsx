...
const CourseMediumTrader = () => {
  ...
  return (
    <div className="CourseMediumTrader-warrapper">
      <NavbarTrader />
      <div className="CourseMediumTrader-container">
        <div className="CourseMediumTrader-container-search-input">
          <i className="bi bi-search"></i>
          <input type="text" placeholder="ค้นหารหัสผู้ค้าตราสารหนี้" />
        </div>

        <div className="CourseMediumTrader-container-link">
          <Link
            href="/traders/trainingsCourse"
            className="CourseMediumTrader-nav-item"
          >
            หลักสูตรทั้งหมด
          </Link>
          <Link
      ...
      <div className="CourseMediumTrader-container-card">
        {trainings.length > 0 ? (
...
export default CourseMediumTrader;
